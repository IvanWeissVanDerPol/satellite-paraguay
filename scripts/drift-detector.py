...
def main():
    ...
    parser.add_argument("--threshold", type=float, default=10.0, help="Drift threshold in percent (default: 10)")
    parser.add_argument("--json", action="store_true", help="JSON output")
    parser.add_argument("--strict", action="store_true", help="Exit 1 on any drift >threshold")
    parser.add_argument("--snapshot", action="store_true", help="Snapshot current scorecard as new baseline")
    parser.add_argument("--reset", action="store_true", help="Delete existing snapshot, then take new one")
    ...
    if args.json:
        ...
        if result.get("first_run"):
            ...
            for a in result["alerts"]:
                ...
                print(
                    f"  {a['severity']}  {a['paper_id']} {a['axis']}: "
