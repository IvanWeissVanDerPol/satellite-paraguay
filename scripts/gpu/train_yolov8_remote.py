...
def main():
    ...
    try:
        ...
        print(f"  Pilot baseline: YOLOv8n at 50 epochs on COCO animals.")
        print(f"  Expected mAP: 0.6-0.8 for common species (deer, birds)")
        print(f"  Expected mAP: 0.3-0.5 for cryptic species (jaguar, tapir)")
        ...
        print(f"  GNNP (Guyra Paraguay), Guyra Paraguay, or WWF Paraguay may have data.")
