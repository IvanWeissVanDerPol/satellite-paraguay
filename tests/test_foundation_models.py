...
class TestComputeTileEmbeddings:
    ...
    def test_returns_array(self, tmp_path):
        ...
        result = compute_tile_embeddings(tile_id="test_tile", bbox=bbox, model_name="prithvi", cache_dir=tmp_path)
    ...
    def test_compute_with_mock_model(self, tmp_path):
        ...
        bbox = {"min_lon": -60, "max_lon": -55, "min_lat": -25, "max_lat": -20}
        result = compute_tile_embeddings(tile_id="mock_tile", bbox=bbox, model_name="alphaearth", cache_dir=tmp_path)
