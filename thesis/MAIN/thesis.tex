...
for deforestation detection (F1=0.876 expected).
...
detector (84 conflicts detected, CARE-compliant).
\item \textbf{P0025 Yrupe}: First Paraguay-specific soybean yield
predictor (R²=0.78).
\item \textbf{P0026 Kai}: First YOLOv8 wildlife poaching detector for
Defensores del Chaco.
\item \textbf{P0035 Tataka}: First LSTM air quality forecaster for
Asunción (MAE=11.72 µg/m³).
\end{enumerate}
...
5 Verra projects in Paraguay totaling 123,000 ha. No satellite-based
verification.

\section{Method}

Yvyra combines AlphaEarth embeddings with Verra VCS API. R²=0.79 for AGB.

\section{Results}

F1=0.83 project verification, R²=0.79 carbon stock.
