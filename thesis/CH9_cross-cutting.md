...
- **Justice pattern:** Indigenous territories at 3.27× national rate
...
Chapter 5 documents the 3.27× deforestation disparity in indigenous territories. Cross-cutting analysis reveals that this disparity is **not uniform**:
...
**Implication 3: Indigenous rights.** Paraguay's climate strategy must integrate FPIC for indigenous communities. The 3.27× deforestation disparity suggests that without FPIC-based monitoring, indigenous territories will continue to face disproportionate deforestation.
...
1. **Generalization to other Chaco countries.** Will the 3.27× deforestation disparity hold in Argentina and Bolivia?
