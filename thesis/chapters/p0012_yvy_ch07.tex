...
ten territories is 27.76\%, versus 8.50\% in the national-average
sample, for a measured disparity ratio of 3.27, which we round to
\textbf{3.27}$\times$ in the headline. The full per-territory breakdown
...
territories is 27.76\%, yielding a disparity ratio of 27.76 / 8.50
= 3.27.}
...
\midrule
\textbf{Mean (10 territories)} & --- & \textbf{27.76} \\
\textbf{National average}       & --- & \textbf{8.50} \\
\bottomrule
\end{tabular}
\end{table}

\paragraph{Statistical significance.} The one-sample t-test on per-territory proportions yields
$t(9) = 3.99$, one-sided $p = 0.0016$ (Cohen's $h = 0.52$). The 95\%
bootstrap confidence interval on the disparity ratio is
$[2.26, 4.37]\times$, which does not include 1.0. The direction of the
...
\paragraph{Interpretation.} The 3.27$\times$ headline reverses the
...
\begin{itemize}
    ...
    headline is conservatively 2.26$\times$ at the lower 95\% CI bound
    choice.
\end{itemize}
...
loss (27.76\%) is approximately 3.27$\times$ the national average
