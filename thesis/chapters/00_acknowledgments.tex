...
conducted while the author completed the \textit{Facultad
Politécnica de la Universidad Nacional de Asunción} (FP-UNA) undergraduate program at the
\textit{Universidad Nacional de Asunción} (UNA), with primary
funding from the author's personal stipend and infrastructure
support from FP-UNA computing resources. No external grant
...
The author thanks the \textbf{FP-UNA thesis committee} for
institutional review (when assigned), and the open-source community
whose tools (Hansen GFC, MapBiomas Paraguay, OpenStreetMap, Prithvi,
AlphaEarth, DINOv2, YOLOv8, TimesFM, the Python scientific stack)
made this thesis possible.

% Cristaldo thank-you removed 2026-09-09 (no adviser identified yet —
% see banner above). The original acknowledgment read:
%   "The author thanks \textbf{Juan Carlos Cristaldo} (FP-UNA, Facultad
%    Politécnica) for thesis adviser engagement, the FP-UNA thesis
%    committee for institutional review, and the open-source community
%    whose tools made this thesis possible."
% It is preserved here for audit-trail purposes only.
