...
measured cross-domain transfer ratio of 0.082 is far below the typical
...
epochs on synthetic labels; the cross-domain transfer ratio of 0.082
...
Cross-domain transfer ratio & --- & 0.74 & \textbf{0.082} \\
\bottomrule
\end{tabular}
\end{table}
...
\paragraph{Cross-domain transfer ratio.} The measured cross-domain
transfer ratio (0.082) is the principal negative finding. The ratio
...
indicate interference. The measured 0.082 is below the conventional
...
\paragraph{Cross-domain transfer is task-dependent.} The 0.082 ratio
...
the cross-domain transfer ratio measured 0.082, well below the 0.74
