...
\begin{itemize}
  \item \textbf{\citep{beery2018}} in \textit{Methods in Ecology and Evolution} on
  ...
  \item \textbf{\citep{bowers2021}} in \textit{Ecological Informatics} on
  ...
  \item \textbf{\citep{milani2022}} in \textit{Ecological Informatics} on
  ...
  \item \textbf{\citep{tabak2019}} in \textit{Ecological Informatics} on
...
\begin{itemize}
  \item \textbf{\citep{villon2020}} in \textit{Remote Sensing in Ecology and
  Conservation} on a region-specific detector for coral-reef
  fish — generalization gap measured across geographical
  regions.

  \item \textbf{\citep{chen2020}} in \textit{Methods in Ecology and Evolution}
  ...
  \item \textbf{\citep{beery2018}} in \textit{Remote Sensing in Ecology and
