...
by a factor of 1.5 on average (range 1.4--1.7, corresponding to a mean
under-claim of 35\%). The shortfall is concentrated in dry Chaco sites
where ground surveys systematically miss non-stand-replacing disturbance.
We replicate the finding on 30 Amazon / Congo / SE-Asia projects at a
mean under-claim of 28\%, suggesting the gap is structural rather than
Paraguay-specific. Two practical implications follow. First, the
...
methods for cross-checking Verra claims already exist, and the
remaining work is institutional, not technical. Second, the implicit
fiduciary standard for carbon-credit buyers should shift from
