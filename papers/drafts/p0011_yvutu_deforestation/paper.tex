...
\affiliation[una]{organization={Facultad de Ciencias Exactas y Naturales, Universidad Nacional de Asunci\'on (FADA-UNA)},
                addressline={Asunci\'on}, country={Paraguay}}
...
\begin{keywords}
deforestation \sep satellite computer vision \sep foundation models \sep
Paraguay \sep Chaco \sep Sentinel-2 \sep MapBiomas \sep Prithvi
\end{keywords}
...
\citep{bucher2019gran_chaco}. The Paraguayan Chaco---occupying roughly 60\%
of Paraguay's territory---has experienced one of the highest deforestation
rates globally over the past two decades \citep{vallejos2020deforestation,
...
expansion \citep{hansen2013high, huang2021paraguay}.
...
for satellite imagery \citep{jakubik2023foundation, cong2022satmae,
alphaearth2025} that capture rich spectral, temporal, and spatial priors.
Prithvi \citep{jakubik2023foundation}---a Vision Transformer pretrained on
...
Prithvi \citep{jakubik2023foundation} is a Vision Transformer pretrained on
600 million HLS patches. SatMAE \citep{cong2022satmae} extends the Masked
...
estimation ($R^2 = 0.82$). All three are open-source under Apache 2.0 or
research-friendly terms.

\subsection{Deforestation Detection}
Hansen GFC \citep{hansen2013high} provides annual forest loss/gain at 30 m
...
Yvutu is built on Prithvi-300M \citep{jakubik2023foundation} with a 10-class
