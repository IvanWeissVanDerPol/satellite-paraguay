...
\title{Yvy: Indigenous land rights and deforestation in Paraguay -- \\
       A satellite-based analysis reveals 2.90$\times$ disparity (CI [1.72, 4.20]$\times$, $p<0.001$)}
...
Chaco experience \textbf{2.90$\times$} the national deforestation rate (95\% bootstrap CI
...
Indigenous territories averaged \textbf{24.67\%} forest loss compared
to the national 8.5\% rate, a ratio of \textbf{2.90$\times$} (95\% CI
...
average, with a measured ratio of 2.90$\times$ (24.67\% loss inside vs.
