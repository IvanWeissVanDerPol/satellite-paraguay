...
(see \S\ref{sec:related} for climatology references).
...
\begin{itemize}
  \item \textbf{\citep{wen2019}} — LSTM for PM₂.₅ forecasting in
  Beijing using ground stations + meteorological data. RMSE
  reductions of 15-25% over ARIMA, on urban station networks.
  \item \textbf{Karevan & \citep{napoles2020}} — multi-site LSTM air-quality
  prediction, demonstrating transfer-learning benefits across
  stations.
  \item \textbf{\citep{lin2022}} — transformer-based air-quality
...
\begin{itemize}
  ...
  \item \textbf{\citep{chudnovsky2014}} — MODIS-to-PM₂.₅ scaling in the US.
  \item \textbf{\citep{donkelaar2015}} — global PM₂.₅ for the
...
\begin{itemize}
  \item \textbf{de la \citep{hoz2018}} — a single-station LSTM for
...
\begin{itemize}
  \item \textbf{\citep{artaxo2013}} — South American biomass burning
  aerosol characterization.
  \item \textbf{\citep{kumar2018}} — FRP-AOD scaling relationships during
  Amazon fires.
