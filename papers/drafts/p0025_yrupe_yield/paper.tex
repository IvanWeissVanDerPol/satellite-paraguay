...
\begin{itemize}
  \item \textbf{Kamilaris & \citep{prenafeta2018}} in \textit{Computers and Electronics in
  ...
  \item \textbf{\citep{yang2021}} in \textit{Nature Food}: a meta-review of
  ...
  \item \textbf{\citep{peng2023}} in \textit{Remote Sensing of Environment} on
  ...
  \item \textbf{\citep{huang2022}} in \textit{ISPRS Journal of Photogrammetry and
...
\begin{itemize}
  ...
  \item \textbf{\citep{kattenborn2021}} in \textit{Remote Sensing of Environment}
  on the design choices for agricultural vs. non-agricultural
  transfer learning with Sentinel-2.

  \item \textbf{\citep{tseng2022}} in \textit{Nature Communications Earth &
...
\begin{itemize}
  \item \textbf{\citep{instep2022}} — INBIO's precision agriculture initiative;
