...
(ratified 1993) \citep{ilo169,un2007,ifc2012,carroll2020care}.
...
The five largest pueblos are Mbya Guaran\'i (200, 35.9\% of communities),
Ava Guaran\'i (150, 26.9\%), Pai Tavytera (61, 10.9\%), Ayoreo (26, 4.7\%),
and Nivacle (23, 4.1\%). Together these five account for 82.6\% of all
indigenous communities in Paraguay. See \texttt{ACTUAL\_RESULTS.md}
for the full per-pueblo breakdown.

\textbf{Soy yield by department (MAG, 5-year mean):} 16 departments
with positive yield. The five highest-yield departments are
Amambay (\SI{3095}{kg/ha}), Alto Paraguay (\SI{2982}{kg/ha}),
Paraguar\'i (\SI{2930}{kg/ha}), Cordillera (\SI{2742}{kg/ha}),
and Guair\'a (\SI{2662}{kg/ha}). National mean \SI{2429}{kg/ha}.
